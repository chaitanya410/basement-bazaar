...
const Welcome: React.FC = () => {
  const rawEvents = [
    { id: 1, title: 'Community Health Camp', date: 'June 15, 2023', image: 'PlantationDrive.jpg', description: 'Free health checkups and consultations.', location: 'Central Park, Wardha' },
    { id: 2, title: 'Environmental Cleanup', date: 'July 8, 2023', image: 'BasementsCleaning.jpg', description: 'Join us in cleaning local parks.', location: 'Riverside Area, Wardha' },
    { id: 3, title: 'Youth Leadership', date: 'July 22, 2023', image: 'blanketDonation.JPG', description: 'Empowering young individuals.', location: 'Community Center, Wardha' },
    { id: 4, title: 'Cultural Festival', date: 'August 5-6, 2023', image: 'healthCheckup.jpg', description: 'Celebrating diverse heritage.', location: 'Town Square, Wardha' },
    { id: 5, title: 'Educational Fair', date: 'September 12, 2023', image: 'NitalOrphanage.jpg', description: 'Showcasing opportunities.', location: 'Public School, Wardha' },
    { id: 6, title: 'Senior Citizens', date: 'October 1, 2023', image: 'policeCheriness.jpg', description: 'Honoring the elderly.', location: 'Golden Age Center, Wardha' },
    { id: 7, title: 'Cubs Rally', date: 'October 1, 2023', image: 'sosCubsRally.jpg', description: 'Community engagement.', location: 'Wardha' },
    { id: 8, title: 'Bird Feeders', date: 'October 1, 2023', image: 'BirdFeeders.jpg', description: 'Nature conservation.', location: 'Wardha' },
    { id: 9, title: 'River Cleaning', date: 'October 1, 2023', image: 'DhamRiverCleaning.jpg', description: 'Environmental drive.', location: 'Dham River' },
    { id: 10, title: 'Health Checkup', date: 'October 1, 2023', image: 'HealthCheckup (1).jpg', description: 'Medical services.', location: 'Wardha' },
    { id: 11, title: 'Dog Feeding', date: 'October 1, 2023', image: 'dogFeedingSanskruti.jpg', description: 'Animal welfare.', location: 'Wardha' },
    { id: 12, title: 'Cleaning Drive', date: 'October 1, 2023', image: 'cleaningDrive1.jpg', description: 'Urban cleanliness.', location: 'Wardha' },
    { id: 13, title: 'G20 Meet', date: 'October 1, 2023', image: 'G20Meet.jpg', description: 'Discussion forum.', location: 'Wardha' },
  ];

  // This fixes the image paths dynamically
  const events = rawEvents.map(event => ({
    ...event,
    image: `${import.meta.env.BASE_URL}${event.image}`
  }));
