...
import logo from '/TheBasementsBrand.png'; // <-- 1. Imported logo here
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Sportify Winners', path: '/sportify-winners' },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            >
              {/* <-- 2. Replaced the spans with the img tag here --> */}
              <img 
                src={logo} 
                alt="The Basements Social Forum Logo" 
                className="h-12 w-auto object-contain" 
              />
            </Link>
            <span className="font-display text-xl font-bold">The Basements Social Forum</span>
          </div>
